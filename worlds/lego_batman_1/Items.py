...
red_brick_unlocked_table = {
    ...
    "Fast Grapple Unlocked": LB1ItemData(base_item_id + 535, ItemClassification.useful),
    "Fast Batarangs Unlocked": LB1ItemData(base_item_id + 536, ItemClassification.useful),
    "More Batarang Targets Unlocked": LB1ItemData(base_item_id + 537, ItemClassification.useful),
    "Flaming Batarang Unlocked": LB1ItemData(base_item_id + 538, ItemClassification.useful),
    "Slam Unlocked": LB1ItemData(base_item_id + 539, ItemClassification.useful),
    "More Detonators Unlocked": LB1ItemData(base_item_id + 540, ItemClassification.useful),
    "Amour Plating Unlocked": LB1ItemData(base_item_id + 541, ItemClassification.useful),
    "Sonic Pain Unlocked": LB1ItemData(base_item_id + 542, ItemClassification.useful),
    "Area Effect Unlocked": LB1ItemData(base_item_id + 543, ItemClassification.useful),
    "Bats Unlocked": LB1ItemData(base_item_id + 544, ItemClassification.useful),
    "Freeze Batarang Unlocked": LB1ItemData(base_item_id + 545, ItemClassification.useful),
    "Decoy Unlocked": LB1ItemData(base_item_id + 546, ItemClassification.useful),
    "Fast Walk Unlocked": LB1ItemData(base_item_id + 547, ItemClassification.useful),
    "Faster Pieces Unlocked": LB1ItemData(base_item_id + 548, ItemClassification.useful),
    "Piece Detector Unlocked": LB1ItemData(base_item_id + 549, ItemClassification.useful),
}
