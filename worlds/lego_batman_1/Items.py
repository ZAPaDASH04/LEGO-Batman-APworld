...
red_brick_unlocked_table = {
    ...
    "Score x2 Unlocked": LB1ItemData(base_item_id + 530),
    "Score x4 Unlocked": LB1ItemData(base_item_id + 531),
    "Score x6 Unlocked": LB1ItemData(base_item_id + 532),
    "Score x8 Unlocked": LB1ItemData(base_item_id + 533),
    "Score x10 Unlocked": LB1ItemData(base_item_id + 534),
