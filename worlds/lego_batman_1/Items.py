...
red_brick_unlocked_table = {
    "Decoy Unlocked": LB1ItemData(base_item_id + 515, ItemClassification.useful),
    "Fast Walk Unlocked": LB1ItemData(base_item_id + 516, ItemClassification.useful),
    "Faster Pieces Unlocked": LB1ItemData(base_item_id + 517, ItemClassification.useful),
    "Piece Detector Unlocked": LB1ItemData(base_item_id + 518, ItemClassification.useful),
    "Score x2 Unlocked": LB1ItemData(base_item_id + 519, ItemClassification.useful),
    "Score x4 Unlocked": LB1ItemData(base_item_id + 520, ItemClassification.useful),
    "Score x6 Unlocked": LB1ItemData(base_item_id + 521, ItemClassification.useful),
    "Score x8 Unlocked": LB1ItemData(base_item_id + 522, ItemClassification.useful),
    "Score x10 Unlocked": LB1ItemData(base_item_id + 523, ItemClassification.useful),
    "Stud Magnet Unlocked": LB1ItemData(base_item_id + 524, ItemClassification.useful),
    "Character Studs Unlocked": LB1ItemData(base_item_id + 525, ItemClassification.useful),
    "Minikit Detector Unlocked": LB1ItemData(base_item_id + 526, ItemClassification.useful),
    "Power Brick Detector Unlocked": LB1ItemData(base_item_id + 527, ItemClassification.useful),
    "Always Score Multiply Unlocked": LB1ItemData(base_item_id + 528, ItemClassification.useful),
    "Fast Build Unlocked": LB1ItemData(base_item_id + 529, ItemClassification.useful),
    "Immune to Freeze Unlocked": LB1ItemData(base_item_id + 530, ItemClassification.useful),
    "Regenerate Hearts Unlocked": LB1ItemData(base_item_id + 531, ItemClassification.useful),
    "Extra Hearts Unlocked": LB1ItemData(base_item_id + 532, ItemClassification.useful),
    "Invincibility Unlocked": LB1ItemData(base_item_id + 533, ItemClassification.useful),
    "Fast Grapple Unlocked": LB1ItemData(base_item_id + 534, ItemClassification.useful),
    "Fast Batarangs Unlocked": LB1ItemData(base_item_id + 535, ItemClassification.useful),
    "More Batarang Targets Unlocked": LB1ItemData(base_item_id + 536, ItemClassification.useful),
    "Flaming Batarang Unlocked": LB1ItemData(base_item_id + 537, ItemClassification.useful),
    "Slam Unlocked": LB1ItemData(base_item_id + 538, ItemClassification.useful),
    "More Detonators Unlocked": LB1ItemData(base_item_id + 539, ItemClassification.useful),
    "Amour Plating Unlocked": LB1ItemData(base_item_id + 540, ItemClassification.useful),
    "Sonic Pain Unlocked": LB1ItemData(base_item_id + 541, ItemClassification.useful),
    "Area Effect Unlocked": LB1ItemData(base_item_id + 542, ItemClassification.useful),
    "Bats Unlocked": LB1ItemData(base_item_id + 543, ItemClassification.useful),
    "Freeze Batarang Unlocked": LB1ItemData(base_item_id + 544, ItemClassification.useful),
}
