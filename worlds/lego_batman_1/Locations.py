...
red_brick_purchase_table = {
    ...
    "Fast Grapple Purchased": LocationData(base_location_id + 535, "Shop"),
    "Fast Batarangs Purchased": LocationData(base_location_id + 536, "Shop"),
    "More Batarang Targets Purchased": LocationData(base_location_id + 537, "Shop"),
    "Flaming Batarang Purchased": LocationData(base_location_id + 538, "Shop"),
    "Slam Purchased": LocationData(base_location_id + 539, "Shop"),
    "More Detonators Purchased": LocationData(base_location_id + 540, "Shop"),
    "Amour Plating Purchased": LocationData(base_location_id + 541, "Shop"),
    "Sonic Pain Purchased": LocationData(base_location_id + 542, "Shop"),
    "Area Effect Purchased": LocationData(base_location_id + 543, "Shop"),
    "Bats Purchased": LocationData(base_location_id + 544, "Shop"),
    "Freeze Batarang Purchased": LocationData(base_location_id + 545, "Shop"),
    "Decoy Purchased": LocationData(base_location_id + 546, "Shop"),
    "Fast Walk Purchased": LocationData(base_location_id + 547, "Shop"),
    "Faster Pieces Purchased": LocationData(base_location_id + 548, "Shop"),
    "Piece Detector Purchased": LocationData(base_location_id + 549, "Shop"),
}
