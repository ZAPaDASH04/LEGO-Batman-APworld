...
character_location_table: Dict[str, LocationData] = {
    ...
    "Alfred Collected": LocationData(base_location_id + 3, "The Face-Off"),
    "Batgirl Collected": LocationData(base_location_id + 4, "The Face-Off"),
    "Nightwing Collected": LocationData(base_location_id + 5, "The Face-Off"),
    "Commissioner Gordon Collected": LocationData(base_location_id + 6, "A Surprise for the Commissioner"),
    "Police Officer Collected": LocationData(base_location_id + 7, "The Face-Off"),
    "Fishmonger Collected": LocationData(base_location_id + 8, "There She Goes Again"),
    "Military Policeman Collected": LocationData(base_location_id + 9, "The Face-Off"),
    "Security Guard Collected": LocationData(base_location_id + 10, "The Face-Off"),
    "S.W.A.T Collected": LocationData(base_location_id + 11, "Breaking Blocks"),
    "Scientist Collected": LocationData(base_location_id + 12, "An Enterprising Theft"),
    "Sailor Collected": LocationData(base_location_id + 13, "Rockin' the Docks"),
    "Police Marksman Collected": LocationData(base_location_id + 14, "Dying of Laughter"),
    "Clayface Collected": LocationData(base_location_id + 15, "The Riddler Makes a Withdrawal"),
    "Mr. Freeze Collected": LocationData(base_location_id + 16, "On the Rocks"),
    "Poison Ivy Collected": LocationData(base_location_id + 17, "Green Fingers"),
    "Two-Face Collected": LocationData(base_location_id + 18, "An Enterprising Theft"),  # check about Breaking Blocks
    "The Riddler Collected": LocationData(base_location_id + 19, "Arkham Asylum"),
    "Bane Collected": LocationData(base_location_id + 20, "Rockin' the Docks"),
    "Catwoman Collected": LocationData(base_location_id + 21, "Stealing the Show"),  # check about Arctic World
    "Catwoman (Classic) Collected": LocationData(base_location_id + 22, "Stealing the Show"),
    "Killer Croc Collected": LocationData(base_location_id + 23, "A Daring Rescue"),
    "Man-Bat Collected": LocationData(base_location_id + 24, "Penguin's Lair"),
    "The Penguin Collected": LocationData(base_location_id + 25, "Arkham Asylum"),
    "Harley Quinn Collected": LocationData(base_location_id + 26, "A Surprise for the Commissioner"),  # check about Dying of Laughter
    "The Scarecrow Collected": LocationData(base_location_id + 27, "The Joker's Masterpiece"),
    "Killer Moth Collected": LocationData(base_location_id + 28, "The Lure of the Night"),
    "Mad Hatter Collected": LocationData(base_location_id + 29, "Joker's Home Turf"),
    "The Joker Collected": LocationData(base_location_id + 30, "Arkham Asylum"),
    "The Joker (Tropical) Collected": LocationData(base_location_id + 31, "Dying of Laughter"),
    "Poison Ivy Goon Collected": LocationData(base_location_id + 32, "A Poisonous Appointment"),
    "Zoo Sweeper Collected": LocationData(base_location_id + 33, "Zoo's Company"),
    "Freeze Girl Collected": LocationData(base_location_id + 34, "An Icy Reception"),
    "Yeti Collected": LocationData(base_location_id + 35, "Penguin's Lair"),
    "Riddler Goon Collected": LocationData(base_location_id + 36, "You can Bank on Batman"),
    "Riddler Henchman Collected": LocationData(base_location_id + 37, "You can Bank on Batman"),
    "Penguin Goon Collected": LocationData(base_location_id + 38, "There She Goes Again"),
    "Penguin Henchman Collected": LocationData(base_location_id + 39, "There She Goes Again"),
    "Penguin Minion Collected": LocationData(base_location_id + 40, "Penguin's Lair"),
...
automobile_location_table: Dict[str, LocationData] = {
    ...
    "Police Bike Collected": LocationData(base_location_id + 51, "Two-Face Chase"),
    "Police Van Collected": LocationData(base_location_id + 52, "Two-Face Chase"),
    "Bat-Tank Collected": LocationData(base_location_id + 53, "To the Top of the Tower"),
    "Catwoman's Motorcycle Collected": LocationData(base_location_id + 54, "Stealing the Show"),
    "Two-Face's Armoured Truck Collected": LocationData(base_location_id + 55, "An Enterprising Theft"),
    "Mr. Freeze's Kart Collected": LocationData(base_location_id + 56, "On the Rocks"),
...
watercraft_location_table: Dict[str, LocationData] = {
    ...
    "Police Watercraft Collected": LocationData(base_location_id + 63, "Harbouring a Grudge"),
    "Police Boat Collected": LocationData(base_location_id + 64, "Harbouring a Grudge"),
    "Penguin's Submarine Collected": LocationData(base_location_id + 65, "Harbouring a Grudge"),
    "Killer Croc's Swamp Rider Collected": LocationData(base_location_id + 66, "Harbouring a Grudge"),
...
aircraft_location_table: Dict[str, LocationData] = {
    ...
    "Police Helicopter Collected": LocationData(base_location_id + 73, "Biplane Blast"),
    "Bruce Wayne's Private Jet Collected": LocationData(base_location_id + 74, "Flight of the Bat"),
    "The Joker's Helicopter Collected": LocationData(base_location_id + 75, "Biplane Blast"),
    "The Scarecrow's Biplane Collected": LocationData(base_location_id + 76, "Biplane Blast"),
    "Goon Helicopter Collected": LocationData(base_location_id + 77, "Biplane Blast"),
    "Riddler's jet Collected": LocationData(base_location_id + 78, "Breaking Blocks"),
    "Mad Hatter's Glider Collected": LocationData(base_location_id + 79, "Joker's Home Turf"),
}
...
suit_location_table: Dict[str, LocationData] = {
    ...
    "Heat Protection Suit Collected": LocationData(base_location_id + 81, "Batcave"),
    "Glide Suit Collected": LocationData(base_location_id + 82, "Batcave"),
    "Demolition Suit Collected": LocationData(base_location_id + 83, "Batcave"),
    "Sonic Suit Collected": LocationData(base_location_id + 84, "Batcave"),
    # "Robinsuit": LocationData(base_location_id + 85, "Batcave"),
    "Water Suit Collected": LocationData(base_location_id + 86, "Batcave"),
    "Technology Suit Collected": LocationData(base_location_id + 87, "Batcave"),
    "Magnet Suit Collected": LocationData(base_location_id + 88, "Batcave"),
    "Attract Suit Collected": LocationData(base_location_id + 89, "Batcave"),
}
